            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li><Link to="/class/9" className="text-gray-400 hover:text-primary transition duration-300">Class 9</Link></li>
                        ...
                        <li><Link to="/classes" className="text-gray-400 hover:text-primary transition duration-300 font-semibold">View All Classes</Link></li>
                    </ul>
                </div>
